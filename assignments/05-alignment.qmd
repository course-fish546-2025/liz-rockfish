...
zcat ~/align_assign/F143_mpile.vcf.gz | head -n -1 > ~/align_assign/F143_mpile_trimmed.vcf

# Step 2: Recompress the trimmed file
bgzip ~/align_assign/F143_mpile_trimmed.vcf

# Step 3: (Optional) Index the new file if needed
tabix -p vcf ~/align_assign/F143_mpile_trimmed.vcf.gz
```
